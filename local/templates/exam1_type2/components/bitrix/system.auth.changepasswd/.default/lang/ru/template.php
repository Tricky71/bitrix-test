...
$MESS ['AUTH_LOGIN_ENTER'] = "Заполните логин";
$MESS ['AUTH_CHECKWORD'] = "Контрольная строка:";
$MESS ['AUTH_CHECKWORD_ENTER'] = "Заполните контрольную строку";
$MESS ['AUTH_NEW_PASSWORD'] = "Новый пароль:";
$MESS ['AUTH_NEW_PASSWORD_ENTER'] = "Заполните новый пароль";
$MESS ['AUTH_NEW_PASSWORD_CONFIRM'] = "Подтверждение пароля:";
$MESS ['AUTH_NEW_PASSWORD_CONFIRM_ENTER'] = "Подтверждение пароля:";
...
$MESS["sys_auth_pict_code"] = "Код на картинке";
$MESS["sys_auth_pict_code_enter"] = "Заполните код";
